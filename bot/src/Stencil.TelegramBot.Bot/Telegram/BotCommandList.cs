...
public static class BotCommandList
{
    ...
    [
        ...
        new("sourcesite", "Scrape a page's media: <link> [count] [filter=…]"),
        new("sourceupload", "Scrape a page and load one image to edit"),
        ...
        new("project", "Download the whole project as a .stencil file"),
        ...
        new("blankcolor", "Recolour a blank project's background"),
