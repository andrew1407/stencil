...
// Telegram only linkifies http(s), so the stencil://open?… URL rides inside the browser's launch.html.
// Port of deepLink.js buildDesktopBounceUrl plus openIn.js buildStencilSchemeUrl's server branch.
