...
- **`usecases/<app>/USECASES.md`** — the illustrated walkthrough of an app: scenarios and
  steps with screenshots/GIFs under `usecases/<app>/img/`, generated by the scripts in
  `usecases/capture/` (never hand-edited). User-facing like a README: no architecture, no
