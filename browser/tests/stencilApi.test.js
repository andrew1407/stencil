...
// ── Windows: stencil.openWindow(title) + the per-window openers ──────────────
// Each window opens through its own shell (the overlay's __stencilModal), flying out of
// its toolbar control; the control's disabled state gates the script route like a click.
