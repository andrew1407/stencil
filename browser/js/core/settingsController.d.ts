...
export declare class SettingsController {
  ...
  app: DrawingApp;
  /** Registry-driven setter (settingsRegistry.js SETTINGS); throws on an unknown key. */
  ...
  /** App-wide motion preference (ui/motionPrefs.js); throws on an unknown key or mode. */
