...
export declare class ImageModel {
  ...
  /** Original dimensions after the current rotation (odd quarter-turns swap w and h). */
  rotatedOriginalDims(): { w: number; h: number };
  effectiveOriginalDims(): { w: number; h: number };
