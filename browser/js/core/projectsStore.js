...
import * as naming from './projectNaming.js';
import * as periods from './projectPeriods.js';
...
export { EXPIRY_MS, WARN_MS, DEFAULT_PERIOD, PERIOD_MS, PERIOD_ORDER, periodMs, addPeriod } from './projectPeriods.js';
export { normalizeKeywords, baseProjectName } from './projectNaming.js';
