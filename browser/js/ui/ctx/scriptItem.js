...
// script window (modalMarkup.js) — the same editor classes at menu scale, its own
// ctx-script-* ids, so the window and the flyout can be open at once.
import { icon } from '../icons.js';

// Hung off the static #ctx-script row by script.js, never in the menu markup. data-ctx-keep-tab:
