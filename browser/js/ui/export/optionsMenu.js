...
// modal-opening toolbar icon uses (popover.js). Alt+hover previews a row (preview.js).
...
import { wireAltPreview, hideExportPreview, clearAltPreviewHover } from './preview.js';
...
import { EXPORT_VARIANTS, EXPORT_VARIANT_LABELS, EXPORT_VARIANT_ICONS,
         exportVariantState } from './variants.js';

// `hotkeyIds` maps a variant to its hotkeysConfig.json id (a row with no live binding shows
// none); rows, order and availability come from variants.js.
