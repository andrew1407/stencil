...
// Numeric fields take an expression, not just a number: "45 + 9" → 54, or "* 9" on a
// current 3 → 27. `<input type="number">` discards non-numeric text, so enhance()
// flips the element to type="text" at runtime and re-adds arrow stepping + min/max
