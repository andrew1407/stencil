// The .stc editor behaviour the script window (modal.js) and the context menu's flyout
// (editor.js) share: action gating, the paint, Tab-indent, Ctrl+Enter and the five
// actions. Each surface keeps only its own chrome — closing the window, marking the menu busy.
// The text itself belongs to neither: both read and write the one buffer (buffer.js).
import { notify } from '../../utils.js';
import { scriptText, setScriptText, subscribeScript } from './buffer.js';
