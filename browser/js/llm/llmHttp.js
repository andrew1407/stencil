// The typed LlmError, the provider-prose sanitizer and the one JSON POST every provider goes
// through (llm-contract.md §6.3). Byte-pinned to browser-extension/src/llm/llmHttp.js.
