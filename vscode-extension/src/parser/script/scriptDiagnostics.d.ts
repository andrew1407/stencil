// Shape of scriptDiagnostics.js — diagnostic construction and the "did you mean" suggester.
import type { ScriptDiagnostic, ScriptToken, Severity } from './scriptTypes.js';
