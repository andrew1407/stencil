...
// requireStore connects to TEST_DATABASE_URL, migrates and truncates, else skips. Deliberately NOT
// DATABASE_URL: the truncate wipes the named database, and that variable points at the LIVE server's.
