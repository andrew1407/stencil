// Package redisbus implements eventbus.Bus over Redis pub/sub, giving the hub
...
func New(ctx context.Context, redisURL string) (eventbus.Bus, error) {
...
func NewWithOptions(ctx context.Context, redisURL string, opts Options) (eventbus.Bus, error) {
...
func (b *redisBus) Publish(ctx context.Context, channel string, env eventbus.Envelope) error {
