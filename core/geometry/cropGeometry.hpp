...
namespace stencil::core {
  ...
  // A width/height swap about the same centre lands on `aspectWoverH` (one page's two aspects
  // are exact reciprocals), so the user's framing carries over. No rect yet -> centeredCrop.
