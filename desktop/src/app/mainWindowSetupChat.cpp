...
namespace stencil::gui {
  ...
  void MainWindow::setupChatDock() {
    ...
    // position decides (browser parity).
    // Without this the panel absorbs the whole freed column when the chat leaves its side.
    // QPointer-guarded: these also fire during teardown, when the docks may be gone.
