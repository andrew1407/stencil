// Headless check of the stroke-growth flight (src/canvas/draw/strokeGrowth.hpp) — the desktop
...
int main(int argc, char** argv) {
  ...
  // Landing empties the list, so the frame loop stops. Stepped past the LONGEST flight plus its ring:
  // this vertex left (20,20) for (50,0), so stepping to the minimum would still be mid-air.
