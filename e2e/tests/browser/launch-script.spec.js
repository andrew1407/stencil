...
test('a local @source is refused by the platform, in the app the user is looking at', async ({ page }) => {
  ...
  // The browser has no filesystem: runScript says so on the line it happened, and the
  // window opens showing the script that failed rather than clearing silently.
