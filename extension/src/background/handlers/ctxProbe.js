// ── ctxTarget probe → per-tab right-click state + dynamic menu visibility ───
// Records what the probe resolved under the cursor and relabels/reveals the menu groups
// that depend on it. Everything here must be synchronous: the native menu is opening.
