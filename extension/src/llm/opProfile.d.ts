// Shapes for llm/opProfile.js — the extension's profile of the shared op registry
// (llm-contract.md §1, §8, §13): the table-driven schema, its limits, and the
// primitives every per-op validator (opValidate.js) shares. Pure — no DOM, no chrome.
import type { Schema, SchemaEntry } from './opSchema.js';
