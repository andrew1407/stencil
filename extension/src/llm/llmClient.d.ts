// Shapes for llm/llmClient.js — the §6 wire mappings. The module itself is a byte-pinned
// port of browser/js/llm/llmClient.js (tests/portParity.test.js), so these shapes are the
// browser's too.
