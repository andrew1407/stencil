...
| App | Path | Stack | Docs | Use cases |
|---|---|---|---|---|
| **Core** | [`core/`](core/) | C++17, STL-only, GUI-free shared library | [core/README.md](core/README.md) | — |
| **Browser** | [`browser/`](browser/) | Vanilla ES-module JS, no build step (optional single-file bundle) | [browser/README.md](browser/README.md) | [browser](usecases/browser/USECASES.md) |
| **Desktop** | [`desktop/`](desktop/) | C++17 + Qt 6, CMake build | [desktop/README.md](desktop/README.md) | [desktop](usecases/desktop/USECASES.md) |
| **CLI** | [`cli/`](cli/) | Zig, wraps the C++ core | [cli/README.md](cli/README.md) | [cli](usecases/cli/USECASES.md) |
...
| **Telegram bot** | [`bot/`](bot/) | .NET (C#), chat-driven editing over the CLI + server REST | [bot/README.md](bot/README.md) | [bot](usecases/bot/USECASES.md) |
...
What each app looks like, scenario by scenario with screenshots and clips, is in
[`usecases/`](usecases/README.md) — one `USECASES.md` per app, including the
[extension](usecases/browser-extension/USECASES.md) and the
[VS Code extension](usecases/vscode-extension/USECASES.md); the images are regenerated by
`usecases/capture/`, never edited by hand.
