...
[`usecases/capture-runner/`](../../capture-runner/README.md) — the console photographed in
a real terminal, the listings rendered from the CLI's own pinned output — never hand-edited.
