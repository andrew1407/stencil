...
// The overlay then arms itself off a dragover carrying a URL (lib/drop/zones.js onOver).
const SRC = readFileSync(repoPath('browser-extension/src/lib/drop/zones.js'), 'utf8');
