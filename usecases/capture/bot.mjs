// Captures usecases/bot/img/* from the real Telegram Web client talking to the bot. Semi-
...
//   node usecases/capture/bot.mjs [--bot stencil_editor_bot] [--profile ~/.stencil-docs-telegram]
