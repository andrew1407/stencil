// The contracts the canonical design table writes down — layout safety, reduced motion, the
// opted-out chevrons — and the host pages plus the injected shell that carry the glyphs inline.
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { ICONS } from '../../../src/lib/icons.js';
import { readFileSync } from 'node:fs';
import { EXT, MOTION, extRules, keyframesOf } from '../../helpers/iconMotionCss.js';
...
// The canonical table's own rules are the browser suite's; these pin that the extension's sheet
// and glyph copies carry the designs the table describes.
