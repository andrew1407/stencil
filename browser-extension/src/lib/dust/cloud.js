...
// posed by flight.js, shaped by grain.js and drawn here in batched fills. A cloud wears one
...
import { FLIGHTS, STYLE_DUST, alphaAt, dustMix, stopOfTint, styleFrame, tintOf,
         turbulenceAt, twinkleAt, TUNE } from './flight.js';
import { addGrainPath, grainShape, headingOf } from './grain.js';
