// A byte port of browser/js/ui/logo/stageRules.js (tests/portParity.test.js): only this header and the
// import paths may differ.
import LOGO_STAGE from './logoStage.json' with { type: 'json' };
...
// current style (cloud.js PARTICLE_STYLES keys), the rest fly none.
