// The full-window logo stage and the lock that makes it the only thing the page listens to.
...
/** True only from the bare window: no stage and no dialog on top. */
...
export declare const openLogoStage: (name: string,
  opts?: { app?: StageApp; origin?: StagePoint | null; doc?: Document }) => boolean;
