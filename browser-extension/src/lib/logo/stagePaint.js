// A byte port of browser/js/ui/logo/stagePaint.js (tests/portParity.test.js): only this header and the
// import paths may differ.
import { faviconSvg, accentHex, normalizeHex } from './accents.js';
