...
// Extension copy of browser/js/llm/llmClient.js (no cross-subproject imports). One
...
// them); anything per-surface lives in llmSurface.js. fetch is injected for `node --test`.
