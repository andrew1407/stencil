//! Parsing the CLI's `wrote …` and `error:` stderr lines into structured results (pure).

use stencil_mcp::outcome::{extract_errors, parse_remotes, parse_wrote, parse_wrote_project, Remote};
